...
final class ClientBillsTable extends PowerGridComponent
{
    use ActionButton;
    ...
    public function addColumns(): ?PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('fullname', function (Client $client) {
                return $client->first_name. ' '. $client->middle_initial. ' '. $client->last_name;
            })
            ->addColumn('route')
            ->addColumn('meter_number')
            ->addColumn('stub_number');
    }
    ...
    public function actions(): array
    {
       return [
           Button::add('Calculate')
               ...
               ->route('clients.bills.create', ['client' => 'id']),

           Button::add('Bills')
                ->target("")
               ->caption('Bills')
               ->class('btn btn-secondary')
               ->route('clients.bills.show', ['client' => 'id'])
               ->method('get')
        ];
    }
