    ...
    */
    public function addColumns(): ?PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ->addColumn('name', function (Bill $model) {
                return $model->client->first_name. ' '. $model->client->middle_initial. ' '. $model->client->last_name;
            })
            ->addColumn('route', function (Bill $model) {
                return $model->client->route;
            })
            ->addColumn('type', function (Bill $model) {
                return $model->client->type == 0 ? 'Disconnected' : 'Active';
            })
            ->addColumn('stub_number', function (Bill $model) {
                return $model->client->stub_number;
            })
